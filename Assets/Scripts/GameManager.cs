...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // タイムライン・ビューが、タイムライン・モデルを持つ
        timelineView = new ViewsOfTimeline.View(new ModelsOfTimeline.Model());
    ...
    void OnTick()
    {
        ...
        this.timelineView.Model.DebugWrite(); // TODO ★ 消す
